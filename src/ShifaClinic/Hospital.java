...
public class Hospital {
    ...
    private static final String password = "Harishothman5";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true){
                System.out.println("Hosptal Management Sysytem");
    ...
    public static void bookAppointment(Patient patient, Doctor doctor, Connection connection, Scanner scanner){
        ...
        if(patient.getPatients(patientId) && doctor.getDoctors(doctorId)){
